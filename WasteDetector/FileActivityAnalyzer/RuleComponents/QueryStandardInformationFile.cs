...
{
    public class QueryStandardInformationFile : IRuleComponent
    {
        private Rule m_Rule;
        private bool[] m_CanBeOptimized;
        public QueryStandardInformationFile(OpCodes opCodes)
        {
            InitRule(opCodes);
        }
        ...
        private void InitRule(OpCodes opCodes)
        {
            ...
            {
                true,//"CreateFile",
                true//"QueryStandardInformationFile"
            };
        ...
        {
            return "QueryStandardInformationFile rule";
        }
