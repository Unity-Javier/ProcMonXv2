...
{
    public class SetEndOfFileInformationFile : IRuleComponent
    {
        private Rule m_Rule;
        private bool[] m_CanBeOptimized;
        public SetEndOfFileInformationFile(OpCodes opCodes)
        {
            InitRule(opCodes);
        }
        ...
        private void InitRule(OpCodes opCodes)
        {
            ...
            {
                true,//"QueryAttributeInformationVolume",
                true,//"QueryBasicInformationFile",
                true,//"SetEndOfFileInformationFile"
            };
        ...
        {
            return "SetEndOfFileInformationFile rule";
        }
