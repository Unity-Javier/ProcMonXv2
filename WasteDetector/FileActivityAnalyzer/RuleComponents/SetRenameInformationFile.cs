...
{
    public class SetRenameInformationFile : IRuleComponent
    {
        private Rule m_Rule;
        private bool[] m_CanBeOptimized;
        public SetRenameInformationFile(OpCodes opCodes)
        {
            InitRule(opCodes);
        }
        ...
        {
            return "SetRenameInformationFile rule";
        }
